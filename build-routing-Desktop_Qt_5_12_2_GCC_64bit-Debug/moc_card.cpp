...
QT_MOC_LITERAL(3, 16, 14), // "getCurrentPath"
QT_MOC_LITERAL(4, 31, 9), // "sendNodes"
QT_MOC_LITERAL(5, 41, 10), // "RouteNodes"
QT_MOC_LITERAL(6, 52, 12), // "DataManager*"
QT_MOC_LITERAL(7, 65, 2), // "db"
QT_MOC_LITERAL(8, 68, 21) // "createGeolocalisedMap"

    },
    "Card\0createMap\0\0getCurrentPath\0sendNodes\0"
    "RouteNodes\0DataManager*\0db\0"
...
static const uint qt_meta_data_Card[] = {
 ...
 // methods: parameters
    QMetaType::Void,
    QMetaType::QString,
    QMetaType::Int, QMetaType::QVariantList, 0x80000000 | 6,    5,    7,
    QMetaType::Void,
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { int _r = _t->sendNodes((*reinterpret_cast< QVariantList(*)>(_a[1])),(*reinterpret_cast< DataManager*(*)>(_a[2])));
